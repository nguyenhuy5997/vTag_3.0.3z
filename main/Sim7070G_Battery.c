...
//   {
//	   if(VTAG_DeviceParameter.Bat_Level > Bat_raw_pre_charging)
//	   {
//		   Bat_raw_pre_charging = VTAG_DeviceParameter.Bat_Level;
//	   }
//	   else
//	   {
//		   VTAG_DeviceParameter.Bat_Level = Bat_raw_pre_charging;
//	   }
//   }
